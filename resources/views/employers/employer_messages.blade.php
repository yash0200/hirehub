                                            ...
                                            <ul class="contacts">
                                                ...
                                                <li>
                                                    <a href="{{ url("#") }}">
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                <img src="{{ asset("/images/resource/candidate-2.png") }}"
                                                                    class="rounded-circle user_img" alt="">
                                                            </div>
                                                            <div class="user_info">
                                                ...
                                                <li>
                                                    <a href="{{ url("#") }}">
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                <img src="{{ asset("/images/resource/candidate-3.png") }}"
                                                                    class="rounded-circle user_img" alt="">
                                                            </div>
                                                            <div class="user_info">
                                                ...
                                                <li>
                                                    <a href="{{ url("#") }}">
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                <img src="{{ asset("/images/resource/candidate-4.png") }}"
                                                                    class="rounded-circle user_img" alt="">
                                                            </div>
                                                            <div class="user_info">
                                                ...
                                                <li class="active">
                                                    <a href="{{ url("#") }}">
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                <img src="{{ asset("/images/resource/candidate-5.png") }}"
                                                                    class="rounded-circle user_img" alt="">
                                                            </div>
                                                            <div class="user_info">
                                                ...
                                                <li>
                                                    <a href="{{ url("#") }}">
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                <img src="{{ asset("/images/resource/candidate-6.png") }}"
                                                                    class="rounded-circle user_img" alt="">
                                                            </div>
                                                            <div class="user_info">
                                                ...
                                                <li>
                                                    <a href="{{ url("#") }}">
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                <img src="{{ asset("/images/resource/candidate-7.png") }}"
                                                                    class="rounded-circle user_img" alt="">
                                                            </div>
                                                            <div class="user_info">
                                                ...
                                                <li>
                                                    <a href="{{ url("#") }}">
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                <img src="{{ asset("/images/resource/candidate-8.png") }}"
                                                                    class="rounded-circle user_img" alt="">
                                                            </div>
                                                            <div class="user_info">
                                ...
                                <div class=" col-xl-8 col-lg-7 col-md-12 col-sm-12 chat">
                                    <div class="card message-card">
                                        <div class="card-header msg_head">
                                            <div class="d-flex bd-highlight">
                                                <div class="img_cont">
                                                    <img src="{{ asset("/images/resource/candidate-8.png") }}" alt=""
                                        ...
                                        <div class="card-body msg_card_body">
                                            <div class="d-flex justify-content-start mb-2">
                                                <div class="img_cont_msg">
                                                    <img src="{{ asset("/images/resource/candidate-3.png") }}" alt=""
                                            ...
                                            <div class="d-flex justify-content-end mb-2 reply">
                                                <div class="img_cont_msg">
                                                    <img src="{{ asset("/images/resource/candidate-6.png") }}" alt=""
                                                        class="rounded-circle user_img_msg">
