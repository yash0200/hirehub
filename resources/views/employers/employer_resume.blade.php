                    ...
                    <div class="applicants-widget ls-widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="candidate-block-three">
                                <div class="inner-box">
                                    <div class="content">
                                        <figure class="image"><img src="{{ asset("/images/resource/candidate-1.png") }}"
                                                alt=""></figure>
                                    ...
                                    <div class="option-box">
                                        ...
                                        <div class="dropdown resume-action">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><button data-text="View Aplication"><span class="la la-eye"></span> View
                                                        Aplication</button></li>
                                                <li><button data-text="Approve Aplication"><span class="la la-check"></span>
                                                        Approve Aplication</button></li>
                                                <li><button data-text="Reject Aplication"><span
                                                            class="la la-times-circle"></span> Reject Aplication</button>
                                                </li>
                                            </ul>
                                        </div>

                                        <button class="delete-btn" data-text="Delete Aplication"><span
                            ...
                            <div class="candidate-block-three">
                                <div class="inner-box">
                                    <div class="content">
                                        <figure class="image"><img src="{{ asset("/images/resource/candidate-2.png") }}"
                                                alt=""></figure>
                            ...
                            <div class="candidate-block-three">
                                <div class="inner-box">
                                    <div class="content">
                                        <figure class="image"><img src="{{ asset("/images/resource/candidate-3.png") }}"
                                                alt=""></figure>
                            ...
                            <div class="candidate-block-three">
                                <div class="inner-box">
                                    <div class="content">
                                        <figure class="image"><img src="{{ asset("/images/resource/candidate-4.png") }}"
                                                alt=""></figure>
