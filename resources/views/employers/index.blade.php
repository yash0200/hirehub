            ...
            <div class="company-block-four col-xl-4 col-lg-6 col-md-6 col-sm-12">
              <div class="inner-box">
                ...
                <span class="company-logo">
                  <img src="{{ asset($employer->logo ? 'storage/logos/' . $employer->logo : 'images/resource/company-logo/1-1.png') }}" alt="{{ $employer->company_name ?? 'N/A' }}">
                </span>
                <h4>
