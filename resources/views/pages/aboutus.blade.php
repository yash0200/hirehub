...
@section('content')
   <!-- About Section Three -->
    <section class="about-section-three ls-section style-two " style="margin-top:90px">
    ...
    <section class="call-to-action-two" style="background-image: url(images/background/1.jpg);">
      <div class="auto-container">
        ...
        <div class="btn-box">
          <a href="{{ url("#") }}" class="theme-btn btn-style-three">Search Job</a>
          <a href="{{ url("#") }}" class="theme-btn btn-style-two">Apply Job Now</a>
        </div>
      </div>
    </section>
    <!-- End Call To Action -->
