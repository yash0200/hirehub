      ...
      <div class="auto-container">
        <div class="row align-items-center">
          ...
          <div class="image-column col-lg-4 offset-lg-1">
              <!-- Job Block -->
              <div class="job-block mr-30 ml30 mb30 mt30">
                <div class="inner-box">
                  <div class="content">
                    <span class="company-logo"><img class="rounded-circle w50" src="{{ asset('/images/resource/company-3.png') }}" alt=""></span>
              ...
              <!-- Job Block -->
              <div class="job-block mb30">
                <div class="inner-box">
                  <div class="content">
                    <span class="company-logo"><img class="rounded-circle w50" src="{{ asset('/images/resource/company-5.png') }}" alt=""></span>
                    <h4><a href="{{ url('#') }}">Software Engineer (Android), Libraries</a></h4>
                    <ul class="job-info">
                      <li><span class="icon flaticon-briefcase"></span> Segment</li>
                      <li><span class="icon flaticon-map-locator"></span> London, UK</li>
              ...
              <!-- Job Block -->
              <div class="job-block mr-30 ml30">
                <div class="inner-box">
                  <div class="content">
                    <span class="company-logo"><img class="rounded-circle w50" src="{{ asset('/images/resource/company-6.png') }}" alt=""></span>
                    <h4><a href="{{ url('#') }}">Software Engineer (Android), Libraries</a></h4>
                    <ul class="job-info">
                      <li><span class="icon flaticon-briefcase"></span> Segment</li>
                      <li><span class="icon flaticon-map-locator"></span> London, UK</li>
    ...
    <section class="job-categories border-bottom-0">
      <div class="auto-container">
        <div class="d-sm-flex align-items-center justify-content-sm-between wow fadeInUp">
          ...
          <a href="{{ url('#') }}" class="ud-btn-border-theme at-home18 mb-4">View All Categories <i class="fal fa-long-arrow-right"></i></a>
        </div>
          ...
          <div class="category-block at-home18 col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <div class="content">
                ...
                <h4><a href="{{ url('#') }}">Accounting / Finance</a></h4>
          ...
          <div class="category-block at-home18 col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <div class="content">
                ...
                <h4><a href="{{ url('#') }}">Human Resource</a></h4>
          ...
          <div class="category-block at-home18 col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <div class="content">
                ...
                <h4><a href="{{ url('#') }}">Customer Service</a></h4>
                <p>(2 open positions)</p>
              </div>
            </div>
          </div>
          ...
          <div class="category-block at-home18 col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <div class="content">
                ...
                <h4><a href="{{ url('#') }}">Health and Care</a></h4>
          ...
          <div class="category-block at-home18 col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <div class="content">
                ...
                <h4><a href="{{ url('#') }}">Automotive Jobs</a></h4>
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="blog -type-1 at-home21 mb-4 mb-xl-0">
              ...
              <div class="blog-content">
                <div class="d-flex align-items-center">
                  <a href="{{ url('#') }}" class="date fz15 dark-color">April 06 2023</a><span class="text-border-color mx-2">|</span><a href="{{ url('#') }}" class="author fz15 dark-color">By Ali Tufan</a></div>
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="blog -type-1 at-home21 mb-4 mb-xl-0">
              ...
              <div class="blog-content">
                <div class="d-flex align-items-center">
                  <a href="{{ url('#') }}" class="date fz15 dark-color">April 06 2023</a><span class="text-border-color mx-2">|</span><a href="{{ url('#') }}" class="author dark-color fz15">By Ali Tufan</a></div>
