            ...
            <div class="outer-box">
                ...
                <div class="dropdown dashboard-option">
                    ...
                    <ul class="dropdown-menu">
                        <li class="active"><a href="{{ url("dashboard.html") }}"> <i class="la la-home"></i> Dashboard</a></li>
                        <li><a href="{{ url("dashboard-company-profile.html") }}"><i class="la la-user-tie"></i>Company Profile</a></li>
                        <li><a href="{{ url("dashboard-post-job.html") }}"><i class="la la-paper-plane"></i>Post a New Job</a></li>
                        <li><a href="{{ url("dashboard-manage-job.html") }}"><i class="la la-briefcase"></i> Manage Jobs </a></li>
                        <li><a href="{{ url("dashboard-applicants.html") }}"><i class="la la-file-invoice"></i> All Applicants</a></li>
                        <li><a href="{{ url("dashboard-resumes.html") }}"><i class="la la-bookmark-o"></i>Shortlisted Resumes</a></li>
                        ...
                        <li><a href="{{ url("dashboard-resume-alerts.html") }}"><i class="la la-bell"></i>Resume Alerts</a></li>
                        <li><a href="{{ url("dashboard-change-password.html") }}"><i class="la la-lock"></i>Change Password</a></li>
                        <li><a href="{{ url("dashboard-company-profile.html") }}"><i class="la la-user-alt"></i>View Profile</a></li>
                        <li><a href="{{ url("index.html") }}"><i class="la la-sign-out"></i>Logout</a></li>
                        <li><a href="{{ url("index.html") }}"><i class="la la-trash"></i>Delete Profile</a></li>
                    </ul>
                </div>
            </div>
        </div>
