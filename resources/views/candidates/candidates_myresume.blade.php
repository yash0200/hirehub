                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-6 col-md-12">
                    ...
                    <select name="skills[]" class="chosen-select multiple" multiple>
                      ...
                      <option value="SQL" {{ in_array('SQL', old('skills', $resume->skills ?? [])) ? 'selected' : '' }}>SQL</option>
                      ...
                      <option value="Customer Relationship Management (CRM)" {{ in_array('Customer Relationship Management (CRM)', old('skills', $resume->skills ?? [])) ? 'selected' : '' }}>Customer Relationship Management (CRM)</option>
